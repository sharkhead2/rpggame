    ...
    while people[0].dead == False and people[1].dead == False:
        for person in people:
            ...
            if person.player:
                ...
                print("\n\nEnemy Stats:\n\nHealth : {}              Base_Damage : {}              Armor : {}\n                      Suspected Anger: {}".format(d.color.RED + str(otherplayer.health) + d.color.END, d.color.RED + str(otherplayer.damage) + d.color.END, d.color.RED + str(otherplayer.armor) + d.color.END, d.color.RED + otherplayer.get_anger() + d.color.END))
